          ...
          <div class="mb-6">
            ...
            <div>
              <ul class="mt-6 leading-10 px-4">
                <li
                  class="mb-3 p-2 rounded-md flex items-center justify-center bg-blue-400 cursor-pointer"
                  @click="openMenu !== 1 ? openMenu = 1 : openMenu = null"
                >
                  <i class="fas fa-align-left fa-sm text-white"></i>
                </li>
                <li
                  class="mb-3 p-2 rounded-md flex items-center justify-center bg-pink-400 cursor-pointer"
                >
          ...
          <div class="mb-6">
            ...
            <div class="grid grid-cols-1 gap-4 grid-cols-2 mt-6">
              ...
              >
                ...
                >
                  <i
                    class="fas fa-money-bill-wave-alt fa-sm text-indigo-600"
                  ></i>
                </div>
          ...
          <main class="relative z-0 flex-1 pb-8 px-6 bg-white">
            <div class="grid pb-10 mt-4">
              ...
              <div class="grid grid-cols-12 gap-6 border-b-2 pb-5">
                <div
                  class="col-span-12 sm:col-span-12 md:col-span-8 lg:col-span-8 xxl:col-span-8"
                >
                  <div
                ...
                <div
                  class="col-span-12 sm:col-span-12 md:col-span-4 lg:col-span-4 xxl:col-span-4"
                >
                  <div class="p-4">
                    <p class="text-sm text-gray-400">Outstanding Revenue</p>
                    <div class="shadow w-full bg-gray-100 mt-2">
                      <div
                        class="bg-indigo-600 text-xs leading-none py-1 text-center text-white"
                        style="width: 55%"
                      ></div>
                    </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <h3
                        class="text-center text-white text-3xl mt-2 font-bold"
                      >
                        RM 27,580
                      </h3>
